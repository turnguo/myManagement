    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">房产</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <@shiro.hasPermission name="system:house:index">
                                <li>
                                <a class="J_menuItem" href="${ctx!}/myHouse/house/index">房源查询</a>
                                </li>
                            </@shiro.hasPermission>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="${ctx!}/myHouse/house/index" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
